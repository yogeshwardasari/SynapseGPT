...
SYSTEM_PROMPT = """
You are a helpful Agentic AI assistant named SynapseGPT similar to ChatGPT.
...
def build_agent(model_name: str):
    ...
    print("================================")
    print("MODEL BEING USED:", selected_model)
    print("================================")
...
def get_agent(model_name: str | None = None):
    ...
    print("NORMALIZED MODEL:", selected_model)

    if selected_model not in _AGENT_CACHE:
        print("CREATING NEW AGENT:", selected_model)
        _AGENT_CACHE[selected_model] = build_agent(selected_model)
    else:
        print("USING CACHED AGENT:", selected_model)
